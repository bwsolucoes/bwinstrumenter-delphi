    ...
    begin
      ...
      begin
        if ((LocateUnit('System.SysUtils') <> nil) or (LocateUnit('SysUtils') <> nil)) then
          ...
          ed.Insert(LUsesOffset + Length('uses'), fProject.prAppendUsesSysUtils)
      end
      else
      begin
        if ((LocateUnit('System.SysUtils') <> nil) or (LocateUnit('SysUtils') <> nil)) then
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          LFileEdit.Insert(api.apiBeginOffs, Format(fProject.prIntegratorAPI,
            [api.apiCommands]));
        end
      end
      else
