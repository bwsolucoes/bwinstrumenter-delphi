...
implementation
uses
  GpString, gpParser.Units, gpParser.Selections,
...
//  begin
//    if fVstSelectUnitTools.GetCheckedState(aNode) = TCheckedState.unchecked then
//      vstSelectUnits.SetCheckStateForAll(csCheckedNormal, false, false)
//    else
//      if fVstSelectUnitTools.GetCheckedState(aNode) = TCheckedState.checked then
//        vstSelectUnits.SetCheckStateForAll(csUncheckedNormal, false, false);
//    DoOnUnitCheck(aNode, true);
//  end
//  if fVstSelectUnitTools.GetSelectedIndex = 0 then
//  begin
